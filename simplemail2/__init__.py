...
Created: 2013-02-02 by Gerold - http://halvar.at/

Example::

    from simplemail2 import Email
    Email(
...
ACHTUNG!
Hier wird die Weiterentwicklung stattfinden. Dieser Code wird in Teilen
nicht mehr mit dem alten *simplemail*-Zweig kompatibel sein.
"""
